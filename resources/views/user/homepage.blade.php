...
<main id="main">
    <div class="container">
            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        <h2 class="f-title" style="color: white">High tech <b style="color: white">Computer</b></h2>
                        <span class="subtitle" style="color: white">gamming, programing,.. all in one!.</span>
                        <p class="sale-info" style="color: white">Only for: <span class="price">$59.99</span></p>
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-3">
                        <h2 class="f-title" style="color: white">The ultimate <b style="color: red">Exclusive mini gaming PC</b></h2>
                        <span class="f-subtitle" style="color: cornsilk">Light and small, easy to install, powerful core.</span>
        ...
        <div class="wrap-show-advance-info-box style-1 has-countdown">
            <h3 class="title-box">On Sale {{ $saleListCount}}</h3>
            {{-- <div class="wrap-countdown mercado-countdown" data-expire="2020/12/12 12:34:56"></div> --}}
            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container "
            data-items="{{$saleListCount}}" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                {{-- loop sale item --}}
                @foreach ($saleList as $salelist)
                    <div class="product product-style-2 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <div class="wrap-price"><span class="product-price"><span style="text-decoration: line-through">{{$salelist->price}}&#8363;</span> <span>->{{$salelist->sale_price}}</span></span></div>
                        </div>
                    </div>
                @endforeach
