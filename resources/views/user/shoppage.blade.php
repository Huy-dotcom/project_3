                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail" style="display: inline-block; width: 213px; height: 213px;">
                                    <a href="#" title="{{$pd->name}}">
                                        <figure><img src="{{ asset($pd->url) }}"></figure>
                                    </a>
                                </div>
                                <div class="product-info">
                                    <a href="#" class="product-name" style="display: block; height: 36px;"><span>{{ $pd->name }}</span></a>
                                    <div class="wrap-price"><span class="product-price">{{$pd->price}}&#8363;</span></div>
